...
void BKE_rigidbody_rebuild_sim(struct Scene *scene);

void BKE_rigidbody_eval_simulation(struct Scene *scene);

void BKE_rigidbody_object_sync_transforms(struct Scene *scene,
                                          struct Object *ob);
