...
} Gtexdraw = {NULL, NULL, NULL, 0, 0, 0, false, false, {0, 0, 0, 0}, false, false};
...
static void draw_textured_begin(Scene *scene, View3D *v3d, RegionView3D *rv3d, Object *ob)
{
	...
	Gtexdraw.ob = ob;
	Gtexdraw.stencil = NULL;
	Gtexdraw.is_texpaint = false;
	Gtexdraw.texpaint_material = false;
	Gtexdraw.canvas = NULL;
