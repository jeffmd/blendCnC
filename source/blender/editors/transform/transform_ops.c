...
static void TRANSFORM_OT_resize(struct wmOperatorType *ot)
{
	...
	Transform_Properties(
	        ot, P_CONSTRAINT | P_PROPORTIONAL | P_MIRROR | P_GEO_SNAP | P_OPTIONS | P_CENTER);
}
...
static void TRANSFORM_OT_rotate(struct wmOperatorType *ot)
{
	...
	Transform_Properties(
	        ot, P_AXIS | P_CONSTRAINT | P_PROPORTIONAL | P_MIRROR | P_GEO_SNAP | P_CENTER);
}
...
static void TRANSFORM_OT_mirror(struct wmOperatorType *ot)
{
	...
	Transform_Properties(ot, P_CONSTRAINT | P_PROPORTIONAL | P_CENTER);
}
...
static void TRANSFORM_OT_transform(struct wmOperatorType *ot)
{
	...
	Transform_Properties(
	        ot, P_AXIS | P_CONSTRAINT | P_PROPORTIONAL | P_MIRROR | P_ALIGN_SNAP | P_CENTER);
}
