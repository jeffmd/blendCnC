...
{
	return object_clear_transform_generic_exec(C, op, object_clear_loc, 0);
}
...
{
	return object_clear_transform_generic_exec(C, op, object_clear_rot, 0);
}
...
{
	return object_clear_transform_generic_exec(C, op, object_clear_scale, 0);
}
